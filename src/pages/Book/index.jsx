...
import Card from "../Home/Card";import cover1 from "../../assets/covers/1.jpeg";
...
function Book(){
    return(
        <div className="px-10 min-h-screen w-full flex flex-col gap-16">
            ...
            <div className="flex items-center flex-wrap gap-4 justify-center 2xl:justify-start">
                ...
                <Card cover={cover1} like={like} order={order} title={""} author={""} />
                <Card cover={cover1} like={like} order={order} title={""} author={""} />
                <Card cover={cover1} like={like} order={order} title={""} author={""} />
                <Card cover={cover1} like={like} order={order} title={""} author={""} />
                <Card cover={cover1} like={like} order={order} title={""} author={""} />
